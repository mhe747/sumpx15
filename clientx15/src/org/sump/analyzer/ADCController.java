 ...
 *
 */
public class ADCController extends JComponent implements ActionListener, Runnable {
		...
		try {
		  if(getExternalData == false)
			capturedData = device.run();
			  ...
			  capturedData = externalCapturedData;
	...
	public void actionPerformed(ActionEvent event) {
		...
		if (o == timer) {
			...
			if (o == triggerEnable) {
				...
				if (((String)speedSelect.getSelectedItem()).equals("200MHz"))
					filterEnable.setEnabled(false);
				else
